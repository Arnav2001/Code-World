...
class MediumCardWidget extends StatefulWidget {
  @override
  _MediumCardWidgetState createState() => _MediumCardWidgetState();
}

class _MediumCardWidgetState extends State<MediumCardWidget> {
